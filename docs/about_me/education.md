<div style="background-color: black; padding: 40px 20px; font-family: 'Share Tech Mono', monospace;">

  <!-- POST GRAD -->
  <hr style="border: none; height: 3px; background-color: #39FF14; box-shadow: 0 0 10px #39FF14; margin: 0 0 40px 0;">
  <h2 style="color: #39FF14; margin-bottom: 20px;">POST GRAD</h2>

  <div style="background-color: #0a0a0a; color: #39FF14; border: 2px solid #39FF14; box-shadow: 0 0 15px rgba(57, 255, 20, 0.2); padding: 15px; margin-bottom: 20px; border-radius: 8px; overflow: hidden;">
    <a href="https://google.com">
      <img src="../../images/education/bcu.jpg" alt="BCU Logo" style="float: left; margin-right: 15px; border: 1px solid #39FF14; width:140px; height:140px;">
    </a>
    <span>
      <strong style="color: #39FF14; text-shadow: 0 0 5px rgba(57, 255, 20, 0.5);">Masters’s Degree</strong><br>
      Artificial Intelligence<br>
      <strong style="color: #39FF14;">Grade: Merit</strong><br>
      <strong style="color: #39FF14;">Birmingham, United Kingdom</strong>
    </span>
  </div>

  <!-- UNDER GRAD -->
  <hr style="border: none; height: 3px; background-color: #39FF14; box-shadow: 0 0 10px #39FF14; margin: 40px 0;">
  <h2 style="color: #39FF14; margin-bottom: 20px;">UNDER GRAD</h2>

  <div style="background-color: #0a0a0a; color: #39FF14; border: 2px solid #39FF14; box-shadow: 0 0 15px rgba(57, 255, 20, 0.2); padding: 15px; margin-bottom: 20px; border-radius: 8px; overflow: hidden;">
    <a href="https://google.com">
      <img src="../../images/education/uni.png" alt="University Logo" style="float: left; margin-right: 15px; border: 1px solid #39FF14; width:140px; height:140px;">
    </a>
    <span>
      <strong style="color: #39FF14; text-shadow: 0 0 5px rgba(57, 255, 20, 0.5);">Bachelor’s Degree</strong><br>
      Math and Computer Science<br>
      <strong style="color: #39FF14;">GPA: 8.0</strong><br>
      <strong style="color: #39FF14;">India</strong>
    </span>
  </div>

  <!-- Certifications -->
  <h3 style="color: #39FF14; text-transform: uppercase; letter-spacing: 2px; margin-top: 40px; margin-bottom: 20px;">Certifications</h3>

  <!-- IBM -->
  <div style="display: flex; align-items: center; margin-bottom: 10px; color: #39FF14;">
    <a href="https://google.com">
      <img src="../../images/education/ibm.jpg" alt="IBM" style="margin-right: 15px; border: 1px solid #39FF14; width:65px; height:65px;">
    </a>
    <span>
      <strong style="color: #39FF14;">IBM</strong><br>
      Online Certifications
    </span>
  </div>
  <ul style="list-style-type: square; color: #39FF14; margin-left: 80px; margin-bottom: 30px;">
    <li>AI Explainability 360 for AI and ML</li>
    <li>IBM training</li>
  </ul>
  ...
  <div style="display: flex; align-items: center; margin-bottom: 10px; color: #39FF14;">
    <a href="https://google.com">
      <img src="../../images/education/ofs.jpeg" alt="OfS" style="margin-right: 15px; border: 1px solid #39FF14; width:65px; height:65px;">
    </a>
    <span>
      <strong style="color: #39FF14;">Office for Student</strong><br>
      Winner ELAN HACKATHON
    </span>
  </div>
  <ul style="list-style-type: square; color: #39FF14; margin-left: 80px; margin-bottom: 30px;">
    <li>ELAN HACKATHON</li>
    <li>WINNER</li>
  </ul>
  ...
  <div style="display: flex; align-items: center; margin-bottom: 10px; color: #39FF14;">
    <a href="https://google.com">
      <img src="../../images/education/madr.png" alt="IIT Madras" style="margin-right: 15px; border: 1px solid #39FF14; width:65px; height:65px;">
    </a>
    <span>
      <strong style="color: #39FF14;">Indian Institute of Technology, Madras</strong><br>
      MTTS programme
    </span>
  </div>
  <ul style="list-style-type: square; color: #39FF14; margin-left: 80px; margin-bottom: 30px;">
    <li>MTTS Programme</li>
    <li>Level 1</li>
  </ul>
  ...
  <div style="display: flex; align-items: center; margin-bottom: 10px; color: #39FF14;">
    <a href="https://google.com">
      <img src="../../images/education/gfg.jpg" alt="GFG" style="margin-right: 15px; border: 1px solid #39FF14; width:65px; height:65px;">
    </a>
    <span>
      <strong style="color: #39FF14;">GEEKS FOR GEEKS</strong><br>
      Data Science
    </span>
  </div>
  <ul style="list-style-type: square; color: #39FF14; margin-left: 80px; margin-bottom: 30px;">
