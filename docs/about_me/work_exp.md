...
<div class="terminal-wrapper" style="background-color: #000000; padding: 35px; border-radius: 15px; border: 1px solid #1a3d12; font-family: 'Courier New', monospace; box-shadow: inset 0 0 20px #000000, 0 0 30px #0f4a05;">
    ...
    <div style="margin-bottom: 40px; overflow: hidden;">
        <div style="float: left; margin-right: 20px;">
            <img src="../../images/work/figg.jpeg" alt="Research Project" style="width: 140px; height: 140px; border: 2px solid #39ff14; border-radius: 8px; box-shadow: 0 0 15px #39ff1444;">
        </div>
        <div style="color: #39ff14;">
            <strong style="font-size: 1.2em; color: #ffffff;">> Research project</strong><br>
            <span style="color: #26cc0d;">Machine learning Research | Birmingham | 2023</span>
        </div>
        <ul style="color: #ffffff; padding-left: 180px; margin-top: 15px; line-height: 1.6; list-style-type: '> ';">
            <li>Developed and deployed a machine learning driven dashboard to cluster FTSE 100 companies based on risk profiles.</li>
            <li>Managed stakeholder relationships ensuring alignment with goals and responsibilities.</li>
            <li>Engineered a data pipeline to ingest and preprocess financial data, integrating Yahoo Finance API.</li>
            <li>Designed an intuitive dashboard interface enabling stakeholders to explore risk profiles dynamically.</li>
        </ul>
    </div>
    ...
    <div style="margin-bottom: 40px; overflow: hidden;">
        <div style="float: left; margin-right: 20px;">
            <img src="../../images/work/blockchain.png" alt="Data Engineering" style="width: 140px; height: 140px; border: 2px solid #39ff14; border-radius: 8px; box-shadow: 0 0 15px #39ff1444;">
        </div>
        <div style="color: #39ff14;">
            <strong style="font-size: 1.2em; color: #ffffff;">> Data Engineering</strong><br>
            <span style="color: #26cc0d;">Software Engineering Intern | Birmingham | 2024</span>
        </div>
        <ul style="color: #ffffff; padding-left: 180px; margin-top: 15px; line-height: 1.6; list-style-type: '> ';">
            <li>Automated scripts for document generation using Docx module (Python).</li>
            <li>Decomposition of business requirements into technical tasks.</li>
            <li>Created reports for 100+ investment firms.</li>
            <li>Reduced Data-cleaning time by 50% through automation.</li>
            <li>Handled production deploys.</li>
        </ul>
    </div>

    <hr style="border: 0; border-top: 1px dashed #1a3d12; margin: 40px 0;">

    <!-- Experience Block 3 -->
    <div style="margin-bottom: 40px; overflow: hidden;">
        <div style="float: left; margin-right: 20px;">
            <img src="../../images/work/uni.png" alt="Supervised Learning" style="width: 140px; height: 140px; border: 2px solid #39ff14; border-radius: 8px; box-shadow: 0 0 15px #39ff1444;">
        </div>
        <div style="color: #39ff14;">
            <strong style="font-size: 1.2em; color: #ffffff;">> Supervised learning / Physics-informed ML</strong><br>
            <span style="color: #26cc0d;">Machine learning Research | India | 2022</span>
        </div>
        <ul style="color: #ffffff; padding-left: 180px; margin-top: 15px; line-height: 1.6; list-style-type: '> ';">
            ...
            <li>Modeling techniques: boundedness, stability, and sensitivity analysis.</li>
