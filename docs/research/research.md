...
<div class="container py-5">
        <!-- Header -->
        <div class="project-header p-5 text-center mb-5 shadow-lg">
            <h1 class="display-4 fw-bold mb-3">Enhanced Logistic Regression</h1>
            <h2 class="h3 mb-4">with Richards Family Curve</h2>
            <p class="lead mb-0">Replacing the traditional sigmoid with the flexible Richards curve for superior adaptability to asymmetric and non-standard data patterns.</p>
            <div class="mt-4">
                <span class="badge bg-light text-dark fs-6 px-3 py-2 me-2">Advanced Statistical Modeling</span>
                <span class="badge bg-light text-dark fs-6 px-3 py-2 me-2">Python / R Implementation</span>
                <span class="badge bg-light text-dark fs-6 px-3 py-2">Optimization &amp; Regularization</span>
            </div>
        </div>

        <div>
    <!-- Main Container -->
    <div style="background-color: #0a0a0a; color: #e0e0e0; font-family: sans-serif; line-height: 1.6; padding: 30px; max-width: 850px; border-radius: 10px; border: 1px solid #333;">
        
        <!-- Header -->
        <h1 style="color: #ffffff; border-bottom: 2px solid #39FF14; padding-bottom: 10px; text-transform: uppercase; font-size: 24px;">
            Enhanced Logistic Regression with Richards Family Curve
        </h1>

        <h2 style="color: #39FF14; font-size: 20px; margin-top: 25px;">Overview & Innovation</h2>
        <p>Replaced the traditional sigmoid function in logistic regression with a member of the <strong>Richards family of curves</strong> for enhanced adaptability to various data distributions.</p>

        <!-- Formula Section -->
        <h2 style="color: #39FF14; font-size: 20px;">Richards Curve Formula</h2>
        <div style="background-color: #1a1a1a; border: 1px solid #39FF14; padding: 20px; border-radius: 8px; margin: 15px 0; text-align: center; box-shadow: 0 0 15px rgba(57, 255, 20, 0.1);">
            <code style="color: #ffffff; font-size: 1.4em;">
                P(y=1|x) = [1 + exp(-(a + &Sigma; b<sub>i</sub> x<sub>i</sub>))]<sup>-1/m</sup>
            </code>
        </div>
        <p>The flexibility parameter <span style="color: #39FF14; font-weight: bold;">m</span> controls the curve’s steepness, symmetry, and inflection point.</p>

        <h2 style="color: #39FF14; font-size: 20px;">Key Advantages</h2>
        <ul style="list-style-type: square; padding-left: 20px;">
            <li style="margin-bottom: 10px;"><strong style="color: #fff;">Enhanced Model Fit:</strong> Capable of modeling asymmetric or differently shaped data transitions.</li>
            <li style="margin-bottom: 10px;"><strong style="color: #fff;">Reduced Overfitting:</strong> Better captures nuanced data distributions, improving performance in complex scenarios.</li>
        </ul>

        <h2 style="color: #39FF14; font-size: 20px;">Implementation & Challenges</h2>
        <p><strong>Parameter Tuning:</strong> Employed grid search and gradient descent to optimize the additional parameter <span style="color: #39FF14;">m</span> alongside traditional coefficients.</p>
        <p><strong>Interpretability:</strong> Focused on explaining model decisions by analyzing the impact of <span style="color: #39FF14;">m</span> on final predictions.</p>

        <h2 style="color: #39FF14; font-size: 20px;">Applications & Impact</h2>
        <p><strong>Biological & Economic Models:</strong> Effective in modeling population dynamics and asymmetric growth or decline trends.</p>
        
        <p style="background-color: rgba(57, 255, 20, 0.1); padding: 15px; border-left: 4px solid #39FF14; font-style: italic;">
            Enhanced prediction accuracy for datasets with unique growth patterns, leading to more informed decision-making.
        </p>
    </div>
</div>
...
.project-header {
            background: linear-gradient(135deg, var(--radium), var(--radium-dark));
            color: white;
            border-radius: 15px;
            box-shadow: var(--glow-md);
        }
        .formula-box {
            background: #0f4a05;
            border-left: 5px solid var(--radium);
        ...
        .section-icon {
            font-size: 1.4rem;
            filter: drop-shadow(0 0 4px var(--radium));
        }
        .accordion-button {
        ...
        .badge {
            background-color: var(--radium-dark) !important;
            color: var(--radium) !important;
            border: 1px solid var(--radium-dim);
        }
        </style>
