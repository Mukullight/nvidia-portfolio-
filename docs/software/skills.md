...
<table border="1" cellpadding="10" cellspacing="0" style="border-collapse: collapse; width: 100%;">
  <tr>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYwjjMn-_b5VT7y0subPlwRB3hhP2pKRcPpA&s" style="float:left; padding-right:10px" width="100" height="100"> Python
    </td>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://logos-download.com/wp-content/uploads/2016/10/Java_logo_icon.png" style="float:left; padding-right:10px" width="100" height="100"> Java
    </td>
  </tr>
  <tr>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/C_Programming_Language.svg/1200px-C_Programming_Language.svg.png" style="float:left; padding-right:10px" width="100" height="100"> C
    </td>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://cdn-icons-png.flaticon.com/512/2772/2772128.png" style="float:left; padding-right:10px" width="100" height="100"> SQL
    </td>
  </tr>
  <tr>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDQ9xATLV5OOVY9ml6a7LRhKBBRdRJwpLV7w&s" style="float:left; padding-right:10px" width="100" height="100"> Cypher
    </td>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://upload.wikimedia.org/wikipedia/commons/6/61/HTML5_logo_and_wordmark.svg" style="float:left; padding-right:10px" width="100" height="100"> HTML
    </td>
  </tr>
  <tr>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://upload.wikimedia.org/wikipedia/commons/d/d5/CSS3_logo_and_wordmark.svg" style="float:left; padding-right:10px" width="100" height="100"> CSS
    </td>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/LaTeX_logo.svg/1200px-LaTeX_logo.svg.png" style="float:left; padding-right:10px" width="100" height="100"> LaTeX
    </td>
  </tr>
</table>
<br>
...
<table border="1" cellpadding="10" cellspacing="0" style="border-collapse: collapse; width: 100%;">
  <tr>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Postgresql_elephant.svg/1200px-Postgresql_elephant.svg.png" style="float:left; padding-right:10px" width="100" height="100"> PostgreSQL
    </td>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://cdn.iconscout.com/icon/free/png-512/mongodb-5-1175140.png" style="float:left; padding-right:10px" width="100" height="100"> MongoDB
    </td>
  </tr>
  <tr>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://avatars.githubusercontent.com/u/108316715?s=280&v=4" style="float:left; padding-right:10px" width="100" height="100"> Chroma
    </td>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Sqlite-square-icon.svg/2048px-Sqlite-square-icon.svg.png" style="float:left; padding-right:10px" width="100" height="100"> SQLite
    </td>
  </tr>
  <tr>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://labs.mysql.com/common/logos/mysql-logo.svg" style="float:left; padding-right:10px" width="100" height="100"> MySQL
    </td>
    <td style="border: 1px solid #000;"></td> <!-- Empty cell for alignment -->
  </tr>
</table>
<br>

<!-- MLOps Frameworks -->
<h3>MLOps Frameworks</h3>
<table border="1" cellpadding="10" cellspacing="0" style="border-collapse: collapse; width: 100%;">
  <tr>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://raw.githubusercontent.com/kubeflow/website/master/static/images/logo.svg" style="float:left; padding-right:10px" width="100" height="100"> Kubeflow
    </td>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://www.docker.com/wp-content/uploads/2022/03/vertical-logo-monochromatic.png" style="float:left; padding-right:10px" width="100" height="100"> Docker
    </td>
  </tr>
  <tr>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/Kubernetes_logo_without_workmark.svg/1200px-Kubernetes_logo_without_workmark.svg.png" style="float:left; padding-right:10px" width="100" height="100"> Kubernetes
    </td>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/OpenShift-LogoType.svg/1200px-OpenShift-LogoType.svg.png" style="float:left; padding-right:10px" width="100" height="100"> OpenShift
    </td>
  </tr>
  <tr>
    <td style="border: 1px solid #000;">
      <img alt="Link" src="https://a0.awsstatic.com/libra-css/images/logos/aws_smile-header-desktop-en-white_59x35.png" style="float:left; padding-right:10px" width="100" height="100"> AWS SageMaker
    </td>
    <td style="border: 1px solid #000;"></td> <!-- Empty cell for alignment -->
  </tr>
</table>
