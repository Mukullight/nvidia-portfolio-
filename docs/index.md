...
.card {
    width: 500px;
    border: 1px solid #26cc0d; /* Radium Dim */
    border-radius: 10px;
    padding: 15px;
    text-align: center;
...
.card:hover {
    ...
    box-shadow: 0 0 20px #39ff1488; /* Radium Glow */
    background-color: #39ff14; /* Card turns Radium Green on hover */
    color: black;
}
.card h3 {
    margin: 10px 0;
...
h1, h2, h3 {
    color: #26cc0d; /* Radium Dim for headings */
    margin: 0.5em 0;
}
 ...
 <div style="background-color: black; color: white; padding: 10px; display: inline-block; max-width:1200px;">
    <div style="background-color: black; color: white; padding: 25px; display: block; font-family: sans-serif; border: 1px solid #1a1a1a; border-radius: 8px; max-width: 1000px;">
    <!-- Two Column Container -->
    <div style="display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 20px;">
        
        <!-- Left Column: Name -->
        <div style="flex: 1; min-width: 250px;">
            <h1 style="color: #39ff14; margin: 0; font-size: 2.8em; text-transform: uppercase; letter-spacing: 2px; line-height: 1;">
                Mukul<br>Namagiri
            </h1>
        </div>

        <!-- Right Column: Contact Details -->
        <div style="flex: 1; min-width: 250px; border-left: 2px solid #1a3d12; padding-left: 20px;">
            <div style="color: #e0e0e0; line-height: 1.8; font-size: 1em;">
                ...
                <div style="margin-bottom: 5px;">
                    <span style="color: #39ff14; font-weight: bold;">&gt;</span> 
                    <strong>Email:</strong> <a href="mailto:mukul.namagiri.pm@gmail.com" style="color: #ffffff; text-decoration: none; background: #0000; padding: 2px 6px; border-radius: 4px; font-weight: bold;"> <span style="color: #ffffff;">mukul.namagiri.pm@gmail.com</span></a>
                </div>
                <div>
                    <span style="color: #39ff14; font-weight: bold;">&gt;</span> 
                    <strong>Phone:</strong>    <a href="tel:+919550121741" style="color: #ffffff; text-decoration: none; background: #0000; padding: 2px 6px; border-radius: 4px; font-weight: bold;">
        <span style="color: #ffffff;">+91 9550121741</span>
    </a>
  ...
  <hr style="border: 2px solid #39ff14; width: 100%; margin: 5px auto;">
  <h2 style="color: #of4a05">Personal Portfolio</h2>
